...
namespace ot {
    ...
    Mesh::Mesh(std::vector<ot::TreeNode> &in, unsigned int k_s, unsigned int pOrder,unsigned int activeNpes,MPI_Comm comm,bool pBlockSetup,unsigned int grainSz,double ld_tol,unsigned int sf_k)
    {
    ...
    Mesh::Mesh(std::vector<ot::TreeNode> &in, unsigned int k_s, unsigned int pOrder,MPI_Comm comm,bool pBlockSetup,unsigned int grainSz,double ld_tol,unsigned int sf_k)
    {
...
*/
    ...
    ot::Mesh* Mesh::ReMesh(unsigned int grainSz,double ld_tol,unsigned int sfK)
    {
        ...
        ot::Mesh * pMesh = new ot::Mesh(balOct1,1,m_uiElementOrder,m_uiCommGlobal,m_uiIsBlockSetup,grainSz,ld_tol,sfK);
        return pMesh;
