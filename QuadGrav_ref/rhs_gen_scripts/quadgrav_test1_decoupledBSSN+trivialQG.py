...
# Ricci scalar, R
# Eqn.23
# WARNING: TERMS REMOVED BY HAND FOR TESTING
Rsc_rhs = - a*Rsch
...
Rsch_rhs = a*(K*Rsch - qg_mass0_sq*Rsc)
...
#+ Aij_rhs1.reshape(3,3) + Aij_rhs2 + Aij_rhs3.reshape(3,3)
Aij_rhs = a*(- Bij) 
...
Btr_rhs = - a*(- qg_mass2_sq*Atr - K*Btr)
...
Bij_rhs = 2/3*a*Btr*(- Kij) 
#+ Bij_rhs2 + Bij_rhs3 - Bij_rhs4 + Bij_rhs5 + Bij_rhs6 + Bij_rhs7 - Bij_rhs8 + Bij_rhs9 - Bij_rhs10 + Bij_rhs11 + Bij_rhs12
