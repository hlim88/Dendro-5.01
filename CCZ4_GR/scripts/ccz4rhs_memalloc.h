  ...
  double *grad2_0_0_theta_z4 = (double *) malloc(bytes);
  double *grad2_0_1_theta_z4 = (double *) malloc(bytes);
  double *grad2_0_2_theta_z4 = (double *) malloc(bytes);
  double *grad2_1_1_theta_z4 = (double *) malloc(bytes);
  double *grad2_1_2_theta_z4 = (double *) malloc(bytes);
  double *grad2_2_2_theta_z4 = (double *) malloc(bytes);
