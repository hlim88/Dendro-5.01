  ...
  ko_deriv_x(grad_0_Gh0, Gh0, hx, sz, bflag);
  ko_deriv_x(grad_0_Gh1, Gh1, hx, sz, bflag);
  ko_deriv_x(grad_0_Gh2, Gh2, hx, sz, bflag);
  ...
  ko_deriv_x(grad_0_theta_z4, theta_z4, hx, sz, bflag);
  ...
  ko_deriv_y(grad_1_Gh0, Gh0, hy, sz, bflag);
  ko_deriv_y(grad_1_Gh1, Gh1, hy, sz, bflag);
  ko_deriv_y(grad_1_Gh2, Gh2, hy, sz, bflag);
  ...
  ko_deriv_y(grad_1_theta_z4, theta_z4, hy, sz, bflag);
  ...
  ko_deriv_z(grad_2_Gh0, Gh0, hz, sz, bflag);
  ko_deriv_z(grad_2_Gh1, Gh1, hz, sz, bflag);
  ko_deriv_z(grad_2_Gh2, Gh2, hz, sz, bflag);
  ...
  ko_deriv_z(grad_2_theta_z4, theta_z4, hz, sz, bflag);
