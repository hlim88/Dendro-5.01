...
#ifndef SFCSORTBENCH_RK3CCZ4_H
#define SFCSORTBENCH_RK3CCZ4_H
...
namespace ode
{
    namespace solver
    {
        ...
        public:
             ...
             * * */
            RK3_CCZ4(ot::Mesh *pMesh, double pTBegin, double pTEnd,double pTh);
