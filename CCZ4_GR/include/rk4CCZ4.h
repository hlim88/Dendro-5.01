...
*@brief rk4 solver for bssn equations.
*/
//

#ifndef SFCSORTBENCH_RK4CCZ4_H
#define SFCSORTBENCH_RK4CCZ4_H
...
namespace ode
{
    namespace solver
    {
        ...
        class RK4_CCZ4 : public RK
        {

        private:

            // variables for CCZ4 formulation.
        ...
        public:
             ...
             * * */
            RK4_CCZ4(ot::Mesh *pMesh, double pTBegin, double pTEnd,double pTh);

            /**@brief default destructor*/
            ~RK4_CCZ4();

            /** @brief: read parameters related to CCZ4 simulation and store them in static variables defined in parameters.h*/
