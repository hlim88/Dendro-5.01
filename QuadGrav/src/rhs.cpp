...
#include "bssnrhs_derivs_adv.h"
    ...
    if (bflag != 0) {
        ...
        bssn_bcs(Rsc_rhs, Rsc, grad_0_Rsc, grad_1_Rsc, grad_2_Rsc, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        bssn_bcs(Rsch_rhs, Rsch, grad_0_Rsch, grad_1_Rsch, grad_2_Rsch, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        bssn_bcs(Rtt_rhs00, Rtt0, grad_0_Rtt0, grad_1_Rtt0, grad_2_Rtt0, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        bssn_bcs(Rtt_rhs01, Rtt1, grad_0_Rtt1, grad_1_Rtt1, grad_2_Rtt1, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        bssn_bcs(Rtt_rhs02, Rtt2, grad_0_Rtt2, grad_1_Rtt2, grad_2_Rtt2, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        bssn_bcs(Rtt_rhs11, Rtt3, grad_0_Rtt3, grad_1_Rtt3, grad_2_Rtt3, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        ...
        bssn_bcs(Vat_rhs00, Vat0, grad_0_Vat0, grad_1_Vat0, grad_2_Vat0, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        bssn_bcs(Vat_rhs01, Vat1, grad_0_Vat1, grad_1_Vat1, grad_2_Vat1, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        bssn_bcs(Vat_rhs02, Vat2, grad_0_Vat2, grad_1_Vat2, grad_2_Vat2, pmin, pmax,
                 1.0, 1.0, sz, bflag);
        bssn_bcs(Vat_rhs11, Vat3, grad_0_Vat3, grad_1_Vat3, grad_2_Vat3, pmin, pmax,
                 1.0, 1.0, sz, bflag);
