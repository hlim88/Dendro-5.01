...
namespace bssn
{
    ...
    int BSSNCtx::write_vtu()
    {
        ...
        m_uiCVar.Get2DArray(consVar,false);
            ...
            bssn::extractConstraints(m_uiMesh,(const DendroScalar **)consVar,evolVar[BHLOC::EXTRACTION_VAR_ID],BHLOC::EXTRACTION_TOL,m_uiTinfo._m_uiStep);
        ...
        #ifdef BSSN_EXTRACT_BH_LOCATIONS
            bssn::writeBHCoordinates((const ot::Mesh *)m_uiMesh,(const Point *) m_uiBHLoc,2,m_uiTinfo._m_uiStep);
        #endif
    ...
    bool BSSNCtx::is_remesh()
    {
        ...
        double wTol=bssn::BSSN_WAVELET_TOL;
            ...
            return bssn::computeWTol(x,y,z,wTol);
        };
        

        if(bssn::BSSN_REFINEMENT_MODE == bssn::RefinementMode::WAMR) {
            isRefine=m_uiMesh->isReMeshUnzip((const double **)unzipVar,refineVarIds,bssn::BSSN_NUM_REFINE_VARS,waveletTolFunc,bssn::BSSN_DENDRO_AMR_FAC); 
        ...
        {
            const bool isR1 = m_uiMesh->isReMeshUnzip((const double **)unzipVar,refineVarIds,bssn::BSSN_NUM_REFINE_VARS,waveletTolFunc,bssn::BSSN_DENDRO_AMR_FAC); 
