...
namespace bssn
{
    ...
    static const char * BSSN_VAR_NAMES[]={"U_ALPHA","U_CHI","U_K","U_GT0","U_GT1","U_GT2","U_BETA0",
                                          "U_BETA1","U_BETA2","U_B0","U_B1","U_B2",
                                          "U_SYMGT0","U_SYMGT1","U_SYMGT2","U_SYMGT3","U_SYMGT4",
                                          "U_SYMGT5","U_SYMAT0","U_SYMAT1","U_SYMAT2","U_SYMAT3",
                                          "U_SYMAT4","U_SYMAT5",
                                          "U_RSC","U_RSCH",
                                          "U_SYMRTT0","U_SYMRTT1","U_SYMRTT2","U_SYMRTT3",
                                          "U_SYMRTT4","U_SYMRTT5","U_SYMVAT0","U_SYMVAT1",
                                          "U_SYMVAT2","U_SYMVAT3","U_SYMVAT4","U_SYMVAT5"};
