...
# Compare with the note, r_vec = 1e^i, theta = 2e^i, phi = 3e^i
...
# This is r^i in the note
r_np = Matrix([[r_vec[0],r_vec[1],r_vec[2]]]) 
# This is Re(m^i), same as Re(bar(m)^i)
m_np_real = Matrix([[theta[0],theta[1],theta[2]]])*invsqrt2 
# This is Im(m^i)
m_np_img = Matrix([[phi[0],phi[1],phi[2]]])*invsqrt2 
# This is Im(bar(m)^i) = - Im(m^i)
m_bar_np_img = - m_np_img

#Below is Psi4 old calculation
'''
