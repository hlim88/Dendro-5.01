...
def main():
    ...
    cudaCompute("../../../BSSN_GR/cuda_gr/include/rhs_bssn.cuh","../../../BSSN_GR/cuda_gr/src/rhs_bssn.cu",bssn_derivs,subset_exp,subset_var,"__computeBSSNRHS",["block_cu.h","params_cu.h","bssn_rhs_deriv_mem_cuda.h","cudaUtils.cuh","derivs.cuh","cudaUtils.h"])
